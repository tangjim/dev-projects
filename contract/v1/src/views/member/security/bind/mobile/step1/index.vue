<template>
    <div class="box">
        <div class="main">
            <div class="plane1">
                <h3>手机号码绑定</h3>
                <p>请务必使用真实本人手机号码，一旦绑定成功不可再次修改</p>
            </div>
            <div class="cut"></div>
            <div class="form-plane">
                <div class="form-input-group"><span class="input-label">手机号码</span><input type="text" v-model="formData.mobilePhone" placeholder="请输入手机号码"/></div>
                <button class="form-btn" :loading="subState===1" @click="sendSms" v-waves>{{btnTxt}}</button>
            </div>
        </div>
    </div>
</template>
