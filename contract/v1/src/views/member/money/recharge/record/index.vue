<template>
    <div class="box">
        <sub-header>
            ...
            <div class="header-title" slot="header-middle">充币记录</div>
        </sub-header>
                        ...
                        <div class="item-wrap">
                            ...
                            <div class="bottom">
                                ...
                                <div class="state">
                                    ...
                                    <template v-if="item.state === 1"><span class="green">充币成功</span></template>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                list: state=>state.userRechargeRecord.list
            }),
        },
        methods: {
            ...mapMutations({
                emptyList: "userRechargeRecord/"+DELETE_ALL
            }),
            ...mapActions({
                getData: 'userRechargeRecord/get'
            }),
            onClose: function() {
                this.$emit("close", "rechargeRecord");
            },
            onLoad() {
                if (this.refreshing) {
                    // this.list = [];
...
<style scoped>
    ...
    .item-wrap .top .title-right {float: right;height:28px;line-height: 28px;margin-top: 18px;padding: 0 8px;font-size:26px;font-family:Microsoft YaHei;font-weight:400;color: rgb(5, 173, 142);}
