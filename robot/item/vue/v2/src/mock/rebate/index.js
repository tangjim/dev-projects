...
Mock.mock(config.baseApi+"/rebate/getRankingList", "post", function (opts) {
    let postData = JSON.parse(opts.body);
    rankingList.sort(function (a, b) {return b.amount-a.amount});
    let newData = rankingList.slice(0, postData.rows);
